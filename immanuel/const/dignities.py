...
DETRIMENT = 2
FALL = 3
MUTUAL_RECEPTION_RULERSHIP = 4
MUTUAL_RECEPTION_EXALTATION = 5
MUTUAL_RECEPTION_HOUSE = 6
TRIPLICITY_RULER_DAY = 7
TRIPLICITY_RULER_NIGHT = 8
TRIPLICITY_RULER_PARTICIPATORY = 9
TERM_RULER = 10
FACE_RULER = 11
PEREGRINE = 12

IGNORE_MUTUAL_RECEPTIONS = 0
INCLUDE_MUTUAL_RECEPTIONS = 1
